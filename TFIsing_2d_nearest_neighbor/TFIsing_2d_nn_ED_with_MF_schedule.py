...
def parse_args():
    parser = argparse.ArgumentParser(description='shortcut to adiabaticity TFI: 2d with mean field schedule')
#    parser.add_argument('-N',metavar='N',dest='N',type=np.int,default=12,help='set N')
    parser.add_argument('-Lx',metavar='Lx',dest='Lx',type=np.int,default=3,help='set Lx')
    parser.add_argument('-Ly',metavar='Ly',dest='Ly',type=np.int,default=3,help='set Ly')
...
## Ham_y = -Sy
## Ham_z = -Sz
def make_ham_2d(Ham_zz,Ham_x,Ham_y,Ham_z,twoS,J,Gamma,Hz,ThDot):
...
#---- for ED
    list_site1, list_site2, list_Jzz = make_list_2(Lx,Ly)
#    _, _, list_Jxx = make_list_2(Lx,Ly)
...
## prepare initial state
    ...
    Ham_ED = make_ham_2d(Ham_zz,Ham_x,Ham_y,Ham_z,twoS,J,Gamma,Hz,ThDot)
    if twoS<10:
...
#
    ...
    plt.plot(list_time,list_ED_norm2,label="2d n.n. TFI, ED")
...
#
    ...
    plt.plot(list_time,list_ED_valSx,label="2d n.n. TFI, ED")
...
#
    ...
    plt.plot(list_time,list_ED_valSy,label="2d n.n. TFI, ED")
    plt.legend(bbox_to_anchor=(0,1),loc='upper left',borderaxespad=1,fontsize=12)
    plt.xlabel("time (from 0 to tau)")
...
#
    ...
    plt.plot(list_time,list_ED_valSz,label="2d n.n. TFI, ED")
    plt.legend(bbox_to_anchor=(0,1),loc='upper left',borderaxespad=1,fontsize=12)
    plt.xlabel("time (from 0 to tau)")
...
#    plt.plot(list_time,list_ED_valHam,label="2d n.n. TFI, ED")
    plt.plot(list_time,np.array(list_ED_valHam)/N,label="2d n.n. TFI, ED")
    plt.legend(bbox_to_anchor=(0,1),loc='upper left',borderaxespad=1,fontsize=12)
    plt.xlabel("time (from 0 to tau)")
